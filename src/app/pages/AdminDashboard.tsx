        ...
        <div className="flex min-h-screen bg-slate-950 text-slate-200">
            ...
            <aside className="w-64 border-r border-slate-800 bg-slate-900/50 p-6 flex flex-col">
                ...
                <nav className="flex-1 space-y-2">
                    <button className="w-full flex items-center gap-3 px-4 py-3 rounded-xl bg-[#00FF88]/10 text-[#00FF88] font-medium transition-all text-left">
                ...
                <div className="mt-auto pt-6 border-t border-slate-800">
                    <div className="flex items-center gap-3 px-4 mb-4">
                        <div className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-[#00FF88] font-bold">
            ...
            <main className="flex-1 p-8 overflow-y-auto">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    <div>
                        <h1 className="text-3xl font-bold mb-1">Painel Central</h1>
                        <p className="text-slate-400">Gerencie seus palpites e análises de IA</p>
                    </div>
                    <button
